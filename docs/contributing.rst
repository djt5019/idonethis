...
`Pull requests <https://github.com/djt5019/idoneit/pulls>`_ or `Github issues <https://github.com/djt5019/idoneit/issues>`_ are always welcome.  If you want to contribute a patch please do the following.
